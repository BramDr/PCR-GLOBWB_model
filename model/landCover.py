...
class LandCover(object):
    ...
    def __init__(
        ...
        self.prioritizeLocalSourceToMeetWaterDemand = (
            iniItems.landSurfaceOptions["prioritizeLocalSourceToMeetWaterDemand"]
            == "True"
        )
    ...
    def updateIrrigationWaterEfficiency(self, currTimeStep):
        ...
        if (
            var in list(self.iniItemsLC.keys())
            or "irrigationEfficiency" in list(self.iniItemsLC.keys())
            and (self.iniItemsLC["name"].startswith("irr"))
        ):
            ...
            self.irrigationEfficiency = pcr.ifthen(
                self.landmask, self.irrigationEfficiency
            )
