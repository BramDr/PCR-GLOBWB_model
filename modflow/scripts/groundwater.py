...
class Groundwater(object):
    ...
    def __init__(self, iniItems, landmask, spinUp):
        ...
        if (
            iniItems.groundwaterOptions["groundwaterPropertiesNC"] == "None"
            or "specificYield" in iniItems.groundwaterOptions.keys()
        ):
        ...
        if (
            iniItems.groundwaterOptions["groundwaterPropertiesNC"] == "None"
            or "kSatAquifer" in iniItems.groundwaterOptions.keys()
        ):
        ...
        if (
            ...
            and "recessionCoeff" not in iniItems.groundwaterOptions.keys()
        ):
        ...
        if (
            "estimateOfTotalGroundwaterThickness" in iniItems.groundwaterOptions.keys()
            ...
            if (
                "maximumTotalGroundwaterThickness" in iniItems.groundwaterOptions.keys()
                and (
        ...
        if (
            iniItems.groundwaterOptions["limitFossilGroundWaterAbstraction"] == "True"
            ...
            if (
                ...
                not in iniItems.groundwaterOptions.keys()
            ):
                iniItems.groundwaterOptions[
                    "estimateOfRenewableGroundwaterCapacity"
                ] = 0.0
        ...
        if iniItems.landSurfaceOptions[
            ...
            groundwaterAllocationSegments = iniItems.landSurfaceOptions[
                "allocationSegmentsForGroundSurfaceWater"
            ]
        ...
        if "allocationSegmentsForGroundwater" in iniItems.groundwaterOptions.keys():
            if iniItems.groundwaterOptions["allocationSegmentsForGroundwater"] not in [
                "None",
                "False",
            ]:
                self.usingAllocSegments = True
                groundwaterAllocationSegments = iniItems.groundwaterOptions[
        ...
        self.maximumDailyGroundwaterAbstraction = vos.readPCRmapClone(
            iniItems.groundwaterOptions["maximumDailyGroundwaterAbstraction"],
            self.cloneMap,
            self.tmpDir,
            self.inputDir,
        )
        ...
        self.maximumDailyFossilGroundwaterAbstraction = vos.readPCRmapClone(
            iniItems.groundwaterOptions["maximumDailyFossilGroundwaterAbstraction"],
            self.cloneMap,
            self.tmpDir,
            self.inputDir,
        )
