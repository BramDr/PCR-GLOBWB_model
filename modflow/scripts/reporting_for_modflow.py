    ...
    def initiate_reporting(self, configuration):
        ...
        try:
            self.outDailyTotNC = list(
                set(configuration.reportingOptions["outDailyTotNC"].split(","))
            )
        except:
            pass
        #
        ...
        try:
            self.outMonthTotNC = list(
                set(configuration.reportingOptions["outMonthTotNC"].split(","))
            )
        except:
            pass
        ...
        try:
            self.outMonthAvgNC = list(
                set(configuration.reportingOptions["outMonthAvgNC"].split(","))
            )
        except:
            pass
        ...
        try:
            self.outMonthEndNC = list(
                set(configuration.reportingOptions["outMonthEndNC"].split(","))
            )
        except:
            pass
        ...
        try:
            self.outAnnuaTotNC = list(
                set(configuration.reportingOptions["outAnnuaTotNC"].split(","))
            )
        except:
            pass
        ...
        try:
            self.outAnnuaAvgNC = list(
                set(configuration.reportingOptions["outAnnuaAvgNC"].split(","))
            )
        except:
            pass
        ...
        try:
            self.outAnnuaEndNC = list(
                set(configuration.reportingOptions["outAnnuaEndNC"].split(","))
            )
        except:
            pass
    ...
    def basic_post_processing(self):
        ...
        for i in range(1, self._model.modflow.number_of_layers + 1):
            ...
            vars(self)[var_head_name] = pcr.ifthen(
                self._model.landmask, vars(self._model.modflow)[var_head_name]
            )
            ...
            if i == self._model.modflow.number_of_layers:
                self.groundwaterHead = pcr.ifthen(
                    self._model.landmask, vars(self)[var_head_name]
                )
                self.groundwaterDepth = pcr.ifthen(
                    self._model.landmask, vars(self)[var_depth_name]
                )

        # relative groundwater head above the minimum level (within the grid)
        self.relativeGroundwaterHead = pcr.ifthen(
            self._model.landmask, self._model.modflow.relativeGroundwaterHead
        )
        ...
        if (
            ...
            self.groundwaterVolumeEstimate = (
                self.groundwaterThicknessEstimate * self._model.modflow.cellAreaMap
            )
        ...
        for i in range(1, self._model.modflow.number_of_layers + 1):
            ...
            totalBaseflowVolumeRate += pcr.cover(
                vars(self._model.modflow)[var_name], 0.0
            )
        ...
        totalBaseflowVolumeRate = pcr.ifthen(
            self._model.landmask, totalBaseflowVolumeRate
        )
        ...
        self.baseflow = pcr.scalar(-1.0) * (
            totalBaseflowVolumeRate / self._model.modflow.cellAreaMap
        )
