...
def main():
    ...
    for opendap_filename in filenames:
        ...
        # target file name
        target_file_name = opendap_filename.replace(
            opendap_main_folder, target_local_folder
        )
        ...
        if os.path.exists(target_file_name):
            msg += (
                "The file "
                + target_file_name
                + " is succesfuly created. Please ignore any above-mentioned ERROR messages related to dimension names of lat/latitude."
            )
        else:
